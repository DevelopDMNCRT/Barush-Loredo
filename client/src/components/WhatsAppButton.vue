...
// No extra logic needed for the simple link button
</script>

<style scoped>
/* Optional: add a slow pulse animation to the button to make it more noticeable */
...
a:hover {
  animation: none; /* Stop pulse on hover and rely on tailwind scale-110 */
}
</style>
